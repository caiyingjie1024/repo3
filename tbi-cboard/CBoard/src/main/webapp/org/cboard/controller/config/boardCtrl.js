            ...
            $uibModal.open({
                ...
                controller: function ($scope, $uibModalInstance) {
                    $scope.param_types = [
                        ...
                        //add by hqb 2019-4-12 begin
                        ,{name: translate('CONFIG.DASHBOARD.PARAM_TYPE_DATE_SECTION'), value: 'date_section'}
                        ,{name: translate('CONFIG.DASHBOARD.PARAM_TYPE_DATETIME_SECTION'), value: 'datetime_section'}
                        ,{name: translate('CONFIG.DASHBOARD.PARAM_TYPE_RANGE_SECTION'), value: 'range_section'}
                        ,{name: translate('CONFIG.DASHBOARD.PARAM_TYPE_DATE'), value: 'date'}
                        ,{name: translate('CONFIG.DASHBOARD.PARAM_TYPE_DATETIME'), value: 'datetime'}
                        ,{name: translate('CONFIG.DASHBOARD.PARAM_TYPE_YEAR'), value: 'year'}
                        ,{name: translate('CONFIG.DASHBOARD.PARAM_TYPE_MONTH'), value: 'month'}
                        ,{name: translate('CONFIG.DASHBOARD.PARAM_TYPE_DAY'), value: 'day'}
                        ,{name: translate('CONFIG.DASHBOARD.PARAM_TYPE_INPUT'), value: 'input'}
                        ,{name: translate('CONFIG.DASHBOARD.PARAM_TYPE_SELECT'), value: 'select'}
                    //add by hqb 2019-4-12 end
                    ];
                    $scope.status = status;
                    $scope.param = param;
